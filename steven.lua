...
if text == (Redis:get(steven.."steven:Name:Bot") or "رقيه") then
local NamesBot = (Redis:get(steven.."steven:Name:Bot") or "رقيه")
local NameBots = {
"محمد "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتــلح دا احجي ويه بنات رقيه بعدين اجاوبك",
...
local CmdStart = '*\n⌔︙أهلآ بك في بوت '..(Redis:get(steven.."steven:Name:Bot") or "رقيه")..
...
return LuaTele.sendText(msg_chat_id,msg_id,'🤴🏻-هلا بيك بابا (المطور)💛', 'md', false, false, false, false, reply_markup)
end
end
