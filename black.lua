...
{
{text = '❇️- تقرير البوتات',type = 'text'},
},
{
...
send(msg_chat_id,msg_id,'❇️-جاري استرجاع المشتركين والجروبات ...')
Y = 0
...
data = {
{
{text = '❇️- صنع بوت',type = 'text'},{text = '❇️- حذف البوت',type = 'text'},
},
{
...
send(msg.chat_id,msg.id,"❇️- مرحبا عزيزي في مصنع الحمايه المجاني لسورس ݪاڪۅﺳت \n❇️- مبرمج السورس @mFJ53","html",true, false, false, true, reply_markup)
return false 
end
---making user
...
----
if text == 'المطور ݪاڪۅﺳت' or text == 'مبرمج السورس' or text == 'ݪاڪۅﺳت' then  
local UserId_Info = LuaTele.searchPublicChat("mFJ53")
...
local TestText = "💖MBIMMS💖\n— — — — — — — — —\n ❍*َdev name❇️-* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n❍*َbio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '💖MBIMMS💖', url = "https://t.me/mFJ53"}
},
}
...
{
{text = '💖MBIMMS💖', url = "https://t.me/habibi123M"},
},
}
local msg_id = msg.id/2097152/0.5 
...
photo = "https://t.me/habibi123M/3432"
local T =[[
 ❍ 💖MBIMMS💖 ❍
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
❍ 𝐷𝐸𝑉 >> [˹ 💖MBIMMS💖 .](https://t.me/mFJ53)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ 
❍ 𝐷𝐸𝑉 >> [˹ 𝐂𝐎𝐒𝐓 .](https://t.me/mFJ53)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ 
❍ـــ❍ >> [˹ 💖MBIMMS💖 .](https://t.me/habibi123M)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'ِّّ💖MBIMMS💖', url = 't.me/habibi123M'}, 
},
}
